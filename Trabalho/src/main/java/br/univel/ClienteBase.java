...
public class ClienteBase extends JPanel {
	...
	public ClienteBase() {
		...
		panel.add(txfNome, gbc_textField_1);
		...
		panel.add(txfTelefone, gbc_textField_2);
		...
		panel_1.add(btnNovo, gbc_btnNewButton);
		...
		panel_1.add(btnSalvar, gbc_btnNewButton_1);
		...
		panel_1.add(btnExcluir, gbc_btnNewButton_2);
